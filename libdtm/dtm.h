...
/*********************************************************************
**
**  /X11/marca/cvsroot/xmosaic/libdtm/dtm.h,v 1.1 1993/01/18 21:50:15 marca Exp
**
**********************************************************************/
...
extern int  DTMgetReturnPortName    PROTO(( int port, char *** addrs,
										int * n_addrs));
...
extern void     dtm_set_float   PROTO(( char * h, char * tag, float f));
