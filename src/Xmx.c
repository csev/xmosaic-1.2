...
{
  XmxSetArg (XmNpromptString, (XtArgVal)XmxMakeXmstrFromString (prompt));
...
{
  XmxSetArg (XmNlabelString,
	     (XtArgVal)XmStringCreateLtoR (text, XmSTRING_DEFAULT_CHARSET));
...
Widget XmxMakeErrorDialog (Widget parent, String name, String title)
{
  ...
  XmxSetArg (XmNdialogTitle,
             (XtArgVal)XmStringCreateLtoR (title, XmSTRING_DEFAULT_CHARSET));
...
{
  XmxSetArg (XmNmessageString,
             (XtArgVal)XmStringCreateLtoR (question, XmSTRING_DEFAULT_CHARSET));
  XmxSetArg (XmNdialogTitle,
             (XtArgVal)XmStringCreateLtoR (title, XmSTRING_DEFAULT_CHARSET));
  XmxSetArg (XmNokLabelString,
	     (XtArgVal)XmStringCreateLtoR ("Yes", XmSTRING_DEFAULT_CHARSET));
  XmxSetArg (XmNcancelLabelString,
	     (XtArgVal)XmStringCreateLtoR ("No", XmSTRING_DEFAULT_CHARSET));
                            ...
                            XtCallbackProc cb, int cb_data)
{
  ...
  XmxSetArg (XmNlabelString, (XtArgVal)XmStringCreateLtoR (selection_txt,
...
{
  XmxSetArg (XmNdialogTitle, (XtArgVal)XmStringCreateSimple (title));
  XmxSetValues (dialog);
...
{
  XmxSetArg (XmNlabelString,
             (XtArgVal)XmStringCreateLtoR (" ", XmSTRING_DEFAULT_CHARSET));
